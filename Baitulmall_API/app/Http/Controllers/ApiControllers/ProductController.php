...
class ProductController extends Controller
{
    ...
    {
        try {
            // Using explicit string for 'true' or boolean; Laravel handles this, but Postgres can be picky.
            // Also grouping where clauses to prevent orWhere from messing up is_active filter.
            ...
            // Log the error so it can be seen in Railway logs
